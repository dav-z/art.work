...
class ArtsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create art" do
    assert_difference('Art.count') do
      post arts_url, params: { art: { image: @art.image, title: @art.title, user_id: @art.user_id } }
    end
  ...
  test "should update art" do
    patch art_url(@art), params: { art: { image: @art.image, title: @art.title, user_id: @art.user_id } }
